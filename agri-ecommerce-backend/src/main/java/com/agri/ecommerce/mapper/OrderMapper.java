...
public class OrderMapper {
    ...
    public OrderResponse toOrderResponse(
        ...
        return OrderResponse.builder()
                ...
                .customerName(customer == null ? order.getShippingName() : customer.getName())
                .customerEmail(customer == null ? order.getGuestEmail() : customer.getEmail())
                .customerPhoneNumber(customer == null ? order.getShippingPhone() : customer.getPhoneNumber())
    ...
    public OrderItemResponse toOrderItemResponse(OrderItemEntity orderItem) {
        ...
        return OrderItemResponse.builder()
                ...
                .productNameEn(product == null ? null : product.getNameEn())
                .productSlug(product == null ? null : product.getSlug())
                .unit(product == null ? null : product.getUnit())
                .unitEn(product == null ? null : product.getUnitEn())
